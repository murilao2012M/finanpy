...
urlpatterns = [
    ...
    path("lancamentos/<int:pk>/duplicar-proximo-mes/", views.duplicar_lancamento_proximo_mes, name="duplicar_lancamento_proximo_mes"),
    path("lancamentos/<int:pk>/marcar-pago/", views.marcar_lancamento_pago, name="marcar_lancamento_pago"),
    path("lancamentos/<int:pk>/recorrencia/", views.criar_recorrencia_lancamento, name="criar_recorrencia_lancamento"),
